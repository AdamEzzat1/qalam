...
| Phase | What | Status |
|---|---|---|
| 1   | Lexical & morphological foundation | In progress — normalize, tokenize, clitics, strong-root morphology, `analyze`, + bootstrap lexicon shipped; weak roots + full open-source lexicon pending |
